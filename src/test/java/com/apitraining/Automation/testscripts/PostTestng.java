...
public class PostTestng {
	...
	public void beforeTest(){
		request = RestAssured.given().auth().basic(prop.getProperty("username"), prop.getProperty("password")).body(prop.getProperty("postpayload_str").toString());
	...
	public void f() {
		...
		response = request.when().post(RestAssured.basePath).then().log()
