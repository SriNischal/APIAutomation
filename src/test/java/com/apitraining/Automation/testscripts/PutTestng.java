...
public class PutTestng {
	...
	public void beforeTest(){
		request = RestAssured.given().auth().basic(prop.getProperty("username"), prop.getProperty("password")).body(prop.getProperty("putpayload_str").toString());
